...
def create_red_team_windows_planning_task(agent, target: str, scan_context: str, vulnerability_context: str) -> Task:
    return Task(
        description=(
            ...
            "Create a controlled Windows/AD red-team validation plan for an authorized target.\n\n"
            f"Target: {target}\n\n"
            ...
            "Avoid credential theft, persistence, destructive actions, or targets outside the authorized target."
        ),
